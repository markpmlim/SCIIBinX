...
{
    //printf("An operation has finished execution.\n");
    operationCount--;
    if (operationCount == 0)
    {
        //printf("All operations have finished execution.\n");
        [progressIndicator stopAnimation:self];
    }
}

// The extraction process is so fast; during testing it could be delayed
// to allow a circular progress indicator to be observed.
// This will cancel ALL operations those currently executing and those
// in the queue.
