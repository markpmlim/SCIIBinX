...
- (id) init
{
    ...
    if (self)
    {
        // we own this object therefore we must deallocate it manually.
        //preferencesController = [[PreferencesWindowController alloc] initWithWindowNibName:@"SciiBinPreferences"];
    }
    return self;
}
